...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    if (
      !args.length ||
      (!client.bassboost[args[0].toLowerCase()] &&
      ...
      return message.channel.send({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["filter"]["bassboost"]["variable1"])
            )
            .setDescription(
              eval(client.la[ls]["cmds"]["filter"]["bassboost"]["variable2"])
            ),
        ],
      });
    ...
    return message.channel.send({
      embeds: [
        new MessageEmbed()
          ...
          .setTitle(
            eval(client.la[ls]["cmds"]["filter"]["bassboost"]["variable3"])
          )
          .setDescription(
            eval(client.la[ls]["cmds"]["filter"]["bassboost"]["variable4"])
          ),
      ],
    });
  },
