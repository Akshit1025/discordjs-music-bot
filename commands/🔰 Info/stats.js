        ...
        new MessageEmbed()
          ...
          .addField(
            ...
            handlemsg(client.la[ls].cmds.info.stats.field1.value, {
              allcommands: Math.ceil(
                (global.commands * [...client.guilds.cache.values()].length) /
                  10
              ),
            }),
            true
          ...
          .addField(
            ...
            handlemsg(client.la[ls].cmds.info.stats.field2.value, {
              allsongs: Math.ceil(
                (global.songs * [...client.guilds.cache.values()].length) / 10
              ),
            }),
            true
          )
          ...
          .addField(
            ...
            handlemsg(client.la[ls].cmds.info.stats.field3.value, {
          ...
          .addField(
            ...
            handlemsg(client.la[ls].cmds.info.stats.field4.value, {
              guildsongs: guild.songs,
            }),
            true
          )
          .setTitle(
            handlemsg(client.la[ls].cmds.info.stats.title, {
