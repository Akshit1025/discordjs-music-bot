...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["music"]["radio"]["variable1"])
            )
            .setDescription(
              eval(client.la[ls]["cmds"]["music"]["radio"]["variable2"])
            ),
        ],
      });
    }
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["music"]["radio"]["variable3"])
            )
            .setDescription(
              eval(client.la[ls]["cmds"]["music"]["radio"]["variable4"])
            ),
        ],
      });
    //define the volume
    ...
    if (Number([args[0]]) > 0 && Number([args[0]]) <= lengthUntil(radios.REYFM))
      ...
      Number([args[0]]) > lengthUntil(radios.REYFM) &&
      Number([args[0]]) <= lengthUntil(radios.ILOVERADIO)
    )
      args2 =
        radios.ILOVERADIO[
          Number([args[0]]) - 1 - lengthUntil(radios.REYFM)
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.ILOVERADIO) &&
      ...
      args2 =
        radios.EU.United_Kingdom[
          Number([args[0]]) - 1 - lengthUntil(radios.ILOVERADIO)
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.United_Kingdom) &&
      ...
      args2 =
        radios.EU.Austria[
          Number([args[0]]) - 1 - lengthUntil(radios.EU.United_Kingdom)
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Austria) &&
      ...
      args2 =
        radios.EU.Belgium[
          Number([args[0]]) - lengthUntil(radios.EU.Austria) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Belgium) &&
      ...
      args2 =
        radios.EU.Bosnia[
          Number([args[0]]) - lengthUntil(radios.EU.Belgium) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Bosnia) &&
      Number([args[0]]) <= lengthUntil(radios.EU.Czech)
    )
      args2 =
        radios.EU.Czech[
          Number([args[0]]) - lengthUntil(radios.EU.Bosnia) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Czech) &&
      ...
      args2 =
        radios.EU.Denmark[
          Number([args[0]]) - lengthUntil(radios.EU.Czech) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Denmark) &&
      ...
      args2 =
        radios.EU.Germany[
          Number([args[0]]) - lengthUntil(radios.EU.Denmark) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Germany) &&
      ...
      args2 =
        radios.EU.Hungary[
          Number([args[0]]) - lengthUntil(radios.EU.Germany) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Hungary) &&
      ...
      args2 =
        radios.EU.Ireland[
          Number([args[0]]) - lengthUntil(radios.EU.Hungary) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Ireland) &&
      ...
      args2 =
        radios.EU.Italy[
          Number([args[0]]) - lengthUntil(radios.EU.Ireland) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Italy) &&
      ...
      args2 =
        radios.EU.Luxembourg[
          Number([args[0]]) - lengthUntil(radios.EU.Italy) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Luxembourg) &&
      ...
      args2 =
        radios.EU.Romania[
          Number([args[0]]) - lengthUntil(radios.EU.Luxembourg) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Romania) &&
      ...
      args2 =
        radios.EU.Serbia[
          Number([args[0]]) - lengthUntil(radios.EU.Romania) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Serbia) &&
      Number([args[0]]) <= lengthUntil(radios.EU.Spain)
    )
      args2 =
        radios.EU.Spain[
          Number([args[0]]) - lengthUntil(radios.EU.Serbia) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Spain) &&
      ...
      args2 =
        radios.EU.Sweden[
          Number([args[0]]) - lengthUntil(radios.EU.Spain) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Sweden) &&
      ...
      args2 =
        radios.EU.Ukraine[
          Number([args[0]]) - lengthUntil(radios.EU.Sweden) - 1
        ].split(` `);
    else if (
      Number([args[0]]) > lengthUntil(radios.EU.Ukraine) &&
      ...
      args2 =
        radios.OTHERS.request[
          Number([args[0]]) - lengthUntil(radios.EU.Ukraine) - 1
        ].split(` `);
      ...
      return message.channel.send({
        embeds: [
          new MessageEmbed()
            ...
            .setDescription(
              `Please use a Station between \`1\` and \`${lengthUntil(
                radios.OTHERS.request
              )}\``
            ),
        ],
