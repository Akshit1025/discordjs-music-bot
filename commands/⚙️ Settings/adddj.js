      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["adddj"]["variable1"])
            ),
        ],
      });
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setFooter(client.getFooter(es))
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["adddj"]["variable2"])
            ),
        ],
      });
    }
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setFooter(client.getFooter(es))
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["adddj"]["variable3"])
            ),
        ],
      });
    ...
    return message.reply({
      embeds: [
        new MessageEmbed()
          ...
          .setFooter(client.getFooter(es))
          .setTitle(
            eval(client.la[ls]["cmds"]["settings"]["adddj"]["variable4"])
          )
          .setDescription(
            eval(client.la[ls]["cmds"]["settings"]["adddj"]["variable5"])
          ),
      ],
    });
  },
