...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["addbotchat"]["variable1"])
            ),
        ],
      });
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setFooter(client.getFooter(es))
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["addbotchat"]["variable2"])
            ),
        ],
      });
    }
    ...
    if (
      client.settings.get(message.guild.id, `botchannel`).includes(channel.id)
    )
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setFooter(client.getFooter(es))
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["addbotchat"]["variable3"])
            ),
        ],
      });
    ...
    if (client.settings.get(message.guild.id, `botchannel`).join(``) === ``)
      leftb = client.la[ls]["common"]["nobotchannels"];
    else
      for (
        let i = 0;
    ...
    return message.reply({
      embeds: [
        new MessageEmbed()
          ...
          .setFooter(client.getFooter(es))
          .setTitle(
            eval(client.la[ls]["cmds"]["settings"]["addbotchat"]["variable4"])
          )
          .setDescription(
            eval(client.la[ls]["cmds"]["settings"]["addbotchat"]["variable5"])
          ),
      ],
    });
  },
