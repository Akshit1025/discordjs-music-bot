...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    var embeds = [
      ...
      .setDescription(`> *I support <:youtube:1050726960172638249> Youtube, <:spotify:1055233276610084904> Spotify, <:soundcloud:1055233067075244033> Soundcloud and direct MP3 Links!*`)
    ]
    var Emojis = [
      "0️⃣",
      "1️⃣",
