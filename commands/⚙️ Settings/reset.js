      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["reset"]["variable1"])
            ),
        ],
      });
    //ask for second yes
      ...
      .reply({
        embeds: [
          new MessageEmbed()
            ...
            .setFooter(client.getFooter(es))
            .setTitle(
              eval(client.la[ls]["cmds"]["settings"]["reset"]["variable2"])
            )
            .setDescription(
              eval(client.la[ls]["cmds"]["settings"]["reset"]["variable3"])
            ),
        ],
      })
      .then((msg) => {
              ...
              return message.reply({
                embeds: [
                  new MessageEmbed()
                    ...
                    .setTitle(
                      eval(
                        client.la[ls]["cmds"]["settings"]["reset"]["variable4"]
                      )
                    ),
            ...
            return message.reply({
              embeds: [
                new MessageEmbed()
                  ...
                  .setTitle(
                    eval(
                      client.la[ls]["cmds"]["settings"]["reset"]["variable6"]
                    )
                  ),
              ],
            });
