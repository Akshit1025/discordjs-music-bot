        ...
        return interaction.reply({
          embeds: [
            new MessageEmbed()
              .setColor(es.wrongcolor)
              .setTitle(
                eval(client.la[ls]["cmds"]["music"]["playskipsc"]["variable1"])
              ),
          ],
        });
      interaction.reply({
        content: `⏭️ Searching and attempting to play: **${args[0]}** from \`Soundcloud\`!`,
      });
      ...
      return interaction.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setDescription(
              eval(client.la[ls]["cmds"]["music"]["playskipsc"]["variable2"])
            ),
        ],
      });
    }
