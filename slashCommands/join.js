  ...
  run: async (
    ...
    try {
      ...
      if (player) {
        ...
        var voiceChannel = message.guild.channels.cache.get(
          player.voiceChannel
        );
        return interaction.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(
                eval(client.la[ls]["cmds"]["music"]["join"]["variable1"])
              ),
          ],
        });
      }
        ...
        return interaction.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(
                eval(client.la[ls]["cmds"]["music"]["join"]["variable2"])
              ),
          ],
        });
      } else {
        return interaction.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setTitle(client.la[ls].common.wrong_vc)
              .setDescription(
                eval(client.la[ls]["cmds"]["music"]["join"]["variable3"])
              ),
          ],
        });
      }
